...
#
# Output
#	- gq_2000.csv	Group Quarters populations for 2000
#	- gq_2010.csv	Group Quarters populations for 2010
#
# Dependencies
#	- censusapi
#	- here
	...
	tryCatch(
			{
				...
				occupied_hhpopvars <- c(
						...
						'PCT013B020', 'PCT013B021', 'PCT013B022', 'PCT013B023', 'PCT013B024', 'PCT013B025', 'PCT013C003',
						'PCT013C004', 'PCT013C005', 'PCT013C006', 'PCT013C007', 'PCT013C008', 'PCT013C009', 'PCT013C010',
						'PCT013C011', 'PCT013C012', 'PCT013C013', 'PCT013C014', 'PCT013C015',
						'PCT013C016', 'PCT013C017', 'PCT013C018', 'PCT013C019', 'PCT013C020', 'PCT013C021', 'PCT013C022',
						'PCT013C023', 'PCT013C024', 'PCT013C025', 'PCT013C027',
						'PCT013C028', 'PCT013C029', 'PCT013C030', 'PCT013C031', 'PCT013C032', 'PCT013C033', 'PCT013C034',
						'PCT013C035',
						'PCT013C036', 'PCT013C037', 'PCT013C038', 'PCT013C039', 'PCT013C040', 'PCT013C041', 'PCT013C042',
						'PCT013C043',
						'PCT013C044', 'PCT013C045', 'PCT013C046', 'PCT013C047', 'PCT013C048', 'PCT013C049',
						'PCT013D003', 'PCT013D004', 'PCT013D005',
						'PCT013D006', 'PCT013D007', 'PCT013D008', 'PCT013D009', 'PCT013D010', 'PCT013D011', 'PCT013D012',
						'PCT013D013',
						'PCT013D014', 'PCT013D015', 'PCT013D016', 'PCT013D017', 'PCT013D018', 'PCT013D019', 'PCT013D020',
						'PCT013D021',
						'PCT013D022', 'PCT013D023', 'PCT013D024', 'PCT013D025', 'PCT013D027', 'PCT013D028', 'PCT013D029',
						'PCT013D030',
						...
						'PCT013B046', 'PCT013B047', 'PCT013B048', 'PCT013B049',
						"COUNTY", "NAME"
				)
				...
				joined <- left_join(totpop, hhpopp) %>%
						...
						dplyr::select(-state, -county, -NAME, -Sex, -Age, -TOTAL, -HHPOP)
